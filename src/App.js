...
function App() {
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbwslINMU-qFNneN-QYV60vS8iks0q13XXd6ONxXOLkcJbz47YkKe9bBkwizfGdUxU_oFw/exec";
  ...
  const onDarkTheme = () => {
    setDark(!dark);
    localStorage.setItem("items", JSON.stringify(!dark));
  };
  ...
  const outer = {
    ...
    visible: {
      opacity: 1,
      pathLength: 1,
      fill: !dark ? "#ffc401" : "#2a2a2a",
    },
  };

  return !showSvg ? (
    <div className={!showSvg ? (!dark ? "svg show" : "svg show dark") : "svg"}>
      <motion.svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148.7 132.28">
          ...
          <Route
            ...
            element={
              <>
                ...
                />
                <About location={about} dark={dark} />
                <Contact
                  location={contact}
                  onSubmit={onSubmit}
                  loader={loader}
